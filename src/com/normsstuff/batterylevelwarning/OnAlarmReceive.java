...
public class OnAlarmReceive extends BroadcastReceiver {
	SimpleDateFormat sdfTime = new SimpleDateFormat("yyyy-MM-dd 'T' HH:mm:ss", Locale.US); // showTime
	  ...
	  public void onReceive(Context context, Intent intent) {
	     ...
	     if(bndl != null){
	    	 timeThisAlarm = bndl.getString(BatteryLevelWarning.TimeOfAlarmID); //  null???
	     }
...
//	     wl_dim = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK, "Dim Lock");
	     ...
	     PowerManager.WakeLock wl_dim = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "Partial Lock");
	     ...
	     Intent intNA = new Intent(context, BatteryLevelWarning.class);
	     intNA.putExtra(BatteryLevelWarning.StartedByID, "OnAlarmReceive");
	     intNA.putExtra(BatteryLevelWarning.TimeOfAlarmID, timeThisAlarm);

...
public class EditTimesFragment extends DialogFragment {
	...
	BatteryLevelWarning.HHMM hhmm;
	int theLoc;
	
	// Save above for callback
	public void setTimeSaver(TimeSaver ts, BatteryLevelWarning.HHMM str, int loc) {
		timeSaver = ts;
		hhmm = str;
		theLoc = loc;
	}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
        		...
        		BatteryLevelWarning.HHMM newHHMM = null;
        		try{
        			newHHMM = new BatteryLevelWarning.HHMM(hoursS+":"+minutesS); 
        		}catch(Exception x){

...
public class ShowEditListFragment extends DialogFragment 
	...
	public interface TimesListHandler {
		public List<BatteryLevelWarning.HHMM> getTimesList();
		public void setTimesList(List<BatteryLevelWarning.HHMM> list);
	...
	ListView lv;
	ArrayAdapter<BatteryLevelWarning.HHMM> aaStr;
	Context cntx;    //<<<<<<<<<<< for showMsg
	final String WorkList_K = "WorkList";
	final String SaveList_K = "SavedList";
	
	List<BatteryLevelWarning.HHMM> hhmmListSaved;
	List<BatteryLevelWarning.HHMM> workList;     // do updates here
    ...
    int deletedPos = -1;
    BatteryLevelWarning.HHMM deletedItem = null;
...
//			hhmmListSaved = ((BatteryLevelWarning)getActivity()).getTimes();       //???? Get from Activity
 ...
 //           mListener = (OnArticleSelectedListener) activity;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        aaStr = new ArrayAdapter<BatteryLevelWarning.HHMM>(getActivity(),
	...
	public void onSaveInstanceState(Bundle bndl) {
		...
		bndl.putParcelableArrayList(WorkList_K, (ArrayList<BatteryLevelWarning.HHMM>)workList);
		bndl.putParcelableArrayList(SaveList_K, (ArrayList<BatteryLevelWarning.HHMM>)hhmmListSaved);
	}
...
//		showMsg("up clicked selItem="+selItem);
		...
		if(selItem > 0) {
			...
			// Move item up
			BatteryLevelWarning.HHMM item = aaStr.getItem(selItem);
			aaStr.remove(item);
...
//		showMsg("edit clicked selItem="+selItem);
		...
		BatteryLevelWarning.HHMM aTime = aaStr.getItem(selItem);
	...
	public void saveTime(BatteryLevelWarning.HHMM hhmm, int loc){
		// remove and insert
		System.out.println("SELF saveTime loc="+loc + ", hhmm="+hhmm);
		BatteryLevelWarning.HHMM oldLine = aaStr.getItem(loc);
	...
	public void addBtnClicked(View v) {
		...
		BatteryLevelWarning.HHMM newItem = new BatteryLevelWarning.HHMM(12,0);
